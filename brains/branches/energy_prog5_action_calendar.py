...
Overview:
  - Reads './branches/bus/energy/baseline_daily.json' + './branches/bus/energy/savings_plan.json'.
  - Emits JSON reminders and an ICS-like text.
  - Prints Answer/Reasons/Check; writes './branches/bus/energy/actions.json' + './branches/bus/energy/actions.ics.txt'.
"""
...
def main():
    ...
    json.dump({"items":a["items"]}, open("./branches/bus/energy/actions.json","w",encoding="utf-8"), indent=2)
    open("./branches/bus/energy/actions.ics.txt","w",encoding="utf-8").write(a["ics_text"])
    print("\nWrote ./branches/bus/energy/actions.json and ./branches/bus/energy/actions.ics.txt")
