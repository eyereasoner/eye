...
Overview:
  - Reads './branches/bus/move/inventory_decisions.json' from Program 1.
  - Assigns box sizes and counts by category and rough density.
  - Estimates tape/labels/wrap and produces per-room labels.
  - Prints Answer/Reason/Check and writes './branches/bus/move/packing_plan.json'.
"""
...
def main():
    ...
    ap.add_argument("--out", default="./branches/bus/move/packing_plan.json")
    args = ap.parse_args()
