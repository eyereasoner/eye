...
Overview:
  - Reads './branches/bus/finance/forecast_30d.json' and './branches/bus/finance/goals_plan.json'.
  - Emits a small reminders list and a minimal .ics-like text file.
  - Prints Answer/Reason/Check and writes './branches/bus/finance/reminders.json' and './branches/bus/finance/reminders.ics.txt'.
"""
...
def main():
    ...
    parser.add_argument("--in_forecast", default="./branches/bus/finance/forecast_30d.json")
    parser.add_argument("--in_goals", default="./branches/bus/finance/goals_plan.json")
    ...
    with open("./branches/bus/finance/reminders.json","w",encoding="utf-8") as f:
        json.dump(rem, f, indent=2, ensure_ascii=False)
    ics = write_ics_like(rem["items"])
    with open("./branches/bus/finance/reminders.ics.txt","w",encoding="utf-8") as f:
        f.write(ics)
    print("\nWrote ./branches/bus/finance/reminders.json and ./branches/bus/finance/reminders.ics.txt")
