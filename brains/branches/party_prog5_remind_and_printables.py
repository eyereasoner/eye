...
def main():
    ...
    json.dump({"items": rem["items"]}, open("./branches/bus/party/reminders.json", "w", encoding="utf-8"), indent=2, ensure_ascii=False)
    open("./branches/bus/party/name_tags.txt", "w", encoding="utf-8").write(rem["name_tags_text"])
    print("\nWrote ./branches/bus/party/reminders.json and ./branches/bus/party/name_tags.txt")
