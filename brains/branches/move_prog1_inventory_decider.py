...
Overview (what this file does, mirrored from this chat):
  - Reads items from a JSON file you provide (see ./branches/bus/move/inventory_sample.json).
...
def main():
    ...
    ap.add_argument("--in", dest="infile", default="./branches/bus/move/inventory_sample.json")
    ap.add_argument("--out", default="./branches/bus/move/inventory_decisions.json")
    args = ap.parse_args()
