...
Overview:
  - Reads './branches/bus/proof/normalized_claims.json' + './branches/bus/proof/lemma_library.json'.
  - For each claim, constructs a proof sketch with concrete witnesses.
  - Prints Answer/Reason/Check; writes './branches/bus/proof/proof_sketches.json' for Program 4.
"""
...
def main():
    ...
    ap.add_argument("--in_lib",  default="./branches/bus/proof/lemma_library.json")
    ap.add_argument("--out",     default="./branches/bus/proof/proof_sketches.json")
    args = ap.parse_args()
