...
def main():
    ...
    ap.add_argument("--infile", default="./branches/bus/party/guest_roster.json")
    ap.add_argument("--out", default="./branches/bus/party/run_of_show.json")
    args = ap.parse_args()
    ...
    open("./branches/bus/party/party_schedule.ics.txt", "w", encoding="utf-8").write(sched["ics_text"])
    print("\nWrote ./branches/bus/party/run_of_show.json and ./branches/bus/party/party_schedule.ics.txt")
