...
Overview (what this file does, mirrored from this chat):
  - Reads './branches/bus/proof/proof_claims_sample.json' (or your file via --infile).
  - Validates schema and normalizes numeric types.
  - Emits './branches/bus/proof/normalized_claims.json' for downstream steps.
...
def main():
    ...
    ap.add_argument("--infile", default="./branches/bus/proof/proof_claims_sample.json")
    ap.add_argument("--out", default="./branches/bus/proof/normalized_claims.json")
    args = ap.parse_args()
