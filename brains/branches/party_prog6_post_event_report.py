...
def main():
    ...
    ap.add_argument("--in_roster", default="./branches/bus/party/guest_roster.json")
    ap.add_argument("--in_menu", default="./branches/bus/party/menu_plan.json")
    ap.add_argument("--in_shop", default="./branches/bus/party/shopping_list.json")
    args = ap.parse_args()
    ...
    json.dump(report, open("./branches/bus/party/party_report.json", "w", encoding="utf-8"), indent=2, ensure_ascii=False)
    write_csv(report, "./branches/bus/party/party_report.csv")
    print("\nWrote ./branches/bus/party/party_report.json and ./branches/bus/party/party_report.csv")
