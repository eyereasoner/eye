...
Overview:
  - Reads './branches/bus/proof/proof_sketches.json'.
  - Checks witnesses and equalities by computation; recomputes gcd and mod conditions.
  - Prints Answer/Reason/Check; writes './branches/bus/proof/proof_verdicts.json' for Program 5.
"""
...
def main():
    ...
    ap.add_argument("--infile", default="./branches/bus/proof/proof_sketches.json")
    ap.add_argument("--out", default="./branches/bus/proof/proof_verdicts.json")
    args = ap.parse_args()
