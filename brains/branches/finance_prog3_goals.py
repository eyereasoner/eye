...
Overview:
  - Reads './branches/bus/finance/forecast_30d.json' and './branches/bus/finance/summary_month.json'.
  - Estimates monthly surplus and allocates by a simple priority rule.
  - Prints Answer/Reason/Check and writes './branches/bus/finance/goals_plan.json' for Program 4.
"""
...
def main():
    ...
    parser.add_argument("--in_summary", default="./branches/bus/finance/summary_month.json")
    parser.add_argument("--out", default="./branches/bus/finance/goals_plan.json")
