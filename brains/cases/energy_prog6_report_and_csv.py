...
Overview:
  - Reads './cases/bus/energy/baseline_daily.json' + './cases/bus/energy/tou_split.json' + './cases/bus/energy/bill_breakdown.json' + './cases/bus/energy/savings_plan.json'.
  - Emits './cases/bus/energy/energy_report.json' and './cases/bus/energy/energy_report.csv'.
...
def main():
    ...
    json.dump(report, open("./cases/bus/energy/energy_report.json","w",encoding="utf-8"), indent=2)
    write_csv(report, "./cases/bus/energy/energy_report.csv")
    print("\nWrote ./cases/bus/energy/energy_report.json and ./cases/bus/energy/energy_report.csv")
