...
% context
'<https://eyereasoner.github.io/ns#propositionProver>'(Premise, Conclusion) :- implies(Premise, Conclusion).
...
% query
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a, +to_be # -to_be).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a & -a, -a).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a, +b # -a).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a & -b, -b & -a).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a, -b # (+b & -a)).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a # (-b # +c), -b # (-a # +c)).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'(-a # +b, (+b & -c) # (-a # +c)).
true :+ '<https://eyereasoner.github.io/ns#propositionProver>'((-a # +c) & (-b # +c), (-a & -b) # +c).
