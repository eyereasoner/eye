...
% context
'<https://eyereasoner.github.io/ns#userPermission>'(User, Permission, Patient) :-
...
% query
true :+ '<https://eyereasoner.github.io/ns#userPermission>'(alice, _, patient1).
true :+ '<https://eyereasoner.github.io/ns#userPermission>'(bob, view_patient_records, patient2).
true :+ '<https://eyereasoner.github.io/ns#userPermission>'([alice, 7], edit_patient_records, patient1).
true :+ \+'<https://eyereasoner.github.io/ns#userPermission>'([alice, 7], edit_patient_records, patient1).
true :+ '<https://eyereasoner.github.io/ns#userPermission>'(_, view_patient_records, patient3).
true :+ '<https://eyereasoner.github.io/ns#userPermission>'(dave, view_patient_records, patient1).
true :+ \+'<https://eyereasoner.github.io/ns#userPermission>'(dave, view_patient_records, patient1).
