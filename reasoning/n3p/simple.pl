flag('no-skolem', 'http://josd.github.io/.well-known/genid/jCxzroGoWPycdYmn8Dh6kH1kPPc#').
...
'<http://example.org/try#p7>'('<http://example.org/try#s7>', '<http://josd.github.io/.well-known/genid/jCxzroGoWPycdYmn8Dh6kH1kPPc#bn_1>').
'<http://example.org/try#p8>'('<http://josd.github.io/.well-known/genid/jCxzroGoWPycdYmn8Dh6kH1kPPc#bn_2>', '<http://example.org/try#o7>').
scount(8).
end_of_file.
