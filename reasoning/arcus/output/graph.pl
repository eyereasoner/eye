...
step((true:+'urn:example:path'(_, 'urn:example:nantes')), 'urn:example:path'('urn:example:angers', 'urn:example:nantes'), true).
step((true:+'urn:example:path'(_, 'urn:example:nantes')), 'urn:example:path'('urn:example:lemans', 'urn:example:nantes'), true).
...
step((true:+'urn:example:path'(_, 'urn:example:nantes')), 'urn:example:path'('urn:example:chartres', 'urn:example:nantes'), true).
step((true:+'urn:example:path'(_, 'urn:example:nantes')), 'urn:example:path'('urn:example:paris', 'urn:example:nantes'), true).
