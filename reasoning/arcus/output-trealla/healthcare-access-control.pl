...
step((true:+'urn:example:userPermission'(alice,A,patient1)),'urn:example:userPermission'(alice,view_patient_records,patient1),true).
step((true:+'urn:example:userPermission'(alice,A,patient1)),'urn:example:userPermission'(alice,edit_patient_records,patient1),true).
step((true:+'urn:example:userPermission'(alice,A,patient1)),'urn:example:userPermission'(alice,access_medications,patient1),true).
...
step((true:+'urn:example:userPermission'(A,view_patient_records,patient3)),'urn:example:userPermission'(alice,view_patient_records,patient3),true).
step((true:+'urn:example:userPermission'(A,view_patient_records,patient3)),'urn:example:userPermission'(bob,view_patient_records,patient3),true).
