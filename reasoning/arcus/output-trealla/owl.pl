...
step((true:+'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(A,B)),'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'('urn:example:large','Size'),true).
step((true:+'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(A,B)),'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'('urn:example:medium','Size'),true).
step((true:+'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(A,B)),'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'('urn:example:small','Size'),true).
step((true:+'urn:example:q'(A,B)),'urn:example:q'('urn:example:o','urn:example:s'),true).
