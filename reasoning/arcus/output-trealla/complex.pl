...
step((true:+'urn:example:sin'([1.570796326794897,1.316957896924817],A)),'urn:example:sin'([1.570796326794897,1.316957896924817],[2.0000000000000004,-6.631275506809351e-16]),true).
step((true:+'urn:example:cos'([0,-1.316957896924817],A)),'urn:example:cos'([0,-1.316957896924817],[2.0000000000000004,0.0]),true).
step((true:+'urn:example:tan'([1.338972522294493,0.4023594781085251],A)),'urn:example:tan'([1.338972522294493,0.4023594781085251],[1.000000000000001,1.9999999999999982]),true).
step((true:+'urn:example:asin'([2,0],A)),'urn:example:asin'([2,0],[1.5707963267948966,1.3169578969248166]),true).
step((true:+'urn:example:acos'([2,0],A)),'urn:example:acos'([2,0],[0.0,-1.3169578969248166]),true).
step((true:+'urn:example:atan'([1,2],A)),'urn:example:atan'([1,2],[1.3389725222944935,0.40235947810852507]),true).
