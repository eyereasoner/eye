...
% proof steps
step((A:+'<http://www.w3.org/2002/07/owl#inverseOf>'(B, C), call(B, D, E), A=..[C, E, D]), ('<http://www.w3.org/2002/07/owl#inverseOf>'(p, q), call(p, s, o), q(o, s)=..[q, o, s]), q(o, s)).
...
step((true:+'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(_, _)), '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(large, 'Size'), true).
step((true:+'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(_, _)), '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(medium, 'Size'), true).
step((true:+'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(_, _)), '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(small, 'Size'), true).
step((true:+q(_, _)), q(o, s), true).
