...
pfx('enigma:', '<http://josd.github.io/eye/reasoning/enigma#>').
cpred('<http://josd.github.io/eye/reasoning/enigma#solve>').

'<http://josd.github.io/eye/reasoning/enigma#solve>'([Size, Permutation], [Board, Max]) :-
