...
step((true:+'urn:example:believes'('urn:example:Fabian',A)),'urn:example:believes'('urn:example:Fabian',('urn:example:notNecessarilyA'(B,'urn:example:gold'):+'urn:example:glitter'(B))),true).
...
step((true:+'urn:example:notNecessarilyA'(A,B)),'urn:example:notNecessarilyA'('urn:example:northStar','urn:example:gold'),true).
