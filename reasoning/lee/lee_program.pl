...
pfx('lee:', '<https://raw.githubusercontent.com/josd/eye/master/reasoning/lee#>').

'<https://raw.githubusercontent.com/josd/eye/master/reasoning/lee#route>'([Source, Destination, Obstacles], Path) :-
