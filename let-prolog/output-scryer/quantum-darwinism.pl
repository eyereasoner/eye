...
step((true:+evolve(state1,A)),evolve(state1,state1),true).
...
step((true:+measured(alice,A),amplitude(alice,B)),(measured(alice,state1),amplitude(alice,0.9)),true).
step((true:+evolve(state1,A)),evolve(state1,state2),true).
step((true:+evolve(state1,A)),evolve(state1,state3),true).
