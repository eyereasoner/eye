...
step((true:+sdcoding(A,B)),sdcoding(1,1),true).
step((true:+sdcoding(A,B)),sdcoding(3,3),true).
step((true:+sdcoding(A,B)),sdcoding(0,0),true).
step((true:+sdcoding(A,B)),sdcoding(2,2),true).
