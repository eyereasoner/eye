...
step((true:+accessControl(john,report1,A)),accessControl(john,report1,allow),true).
step((true:+accessControl(jane,report2,A)),accessControl(jane,report2,allow),true).
step((true:+accessControl(bob,report1,A)),accessControl(bob,report1,allow),true).
