...
step((true:+path(_, nantes)), path(angers, nantes), true).
step((true:+path(_, nantes)), path(lemans, nantes), true).
...
step((true:+path(_, nantes)), path(chartres, nantes), true).
step((true:+path(_, nantes)), path(paris, nantes), true).
