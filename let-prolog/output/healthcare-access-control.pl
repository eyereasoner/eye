...
step((true:+userPermission(alice, _, patient1)), userPermission(alice, view_patient_records, patient1), true).
step((true:+userPermission(alice, _, patient1)), userPermission(alice, edit_patient_records, patient1), true).
step((true:+userPermission(alice, _, patient1)), userPermission(alice, access_medications, patient1), true).
...
step((true:+userPermission(_, view_patient_records, patient3)), userPermission(alice, view_patient_records, patient3), true).
step((true:+userPermission(_, view_patient_records, patient3)), userPermission(bob, view_patient_records, patient3), true).
