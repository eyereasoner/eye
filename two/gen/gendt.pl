...
main :-
    ...
    write(Out,'case(type(_ELEMENT,class(n1))).\n'),
    write(Out,'case(type(_ELEMENT,class(n10))).\n'),
    write(Out,'case(type(_ELEMENT,class(n100))).\n'),
    write(Out,'case(type(_ELEMENT,class(n1000))).\n'),
    write(Out,'case(type(_ELEMENT,class(n10000))).\n'),
    write(Out,'\n'),
    write(Out,'test :-\n'),
    write(Out,'    case(A),\n'),
    write(Out,'    A,\n'),
