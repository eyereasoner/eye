#!/usr/bin/env python3
"""
EYE Learning — Program 1: Inventory Decider (Keep / Donate / Dispose)
...
Overview (what this file does, mirrored from this chat):
  - Reads items from a JSON file you provide (see ./resources/inventory_sample.json).
...
def main():
    ...
    ap.add_argument("--in", dest="infile", default="./resources/inventory_sample.json")
    ap.add_argument("--out", default="./resources/inventory_decisions.json")
    args = ap.parse_args()
