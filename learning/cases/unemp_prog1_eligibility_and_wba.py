...
#!/usr/bin/env python3
"""
EYE Learning — Program 1: Unemployment Eligibility & Weekly Benefit Amount (WBA)
...
Overview:
  ...
  ./resources/eligible_claims.json for Program 2.
"""
...
def main():
    ...
    ap.add_argument("--out", default="./resources/eligible_claims.json")
