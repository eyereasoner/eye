#!/usr/bin/env python3
"""
EYE Learning — Program 1: Ingest & Normalize Claims (Elementary Number Theory)
...
Overview (what this file does, mirrored from this chat):
  - Reads './resources/proof_claims_sample.json' (or your file via --infile).
  - Validates schema and normalizes numeric types.
  - Emits './resources/normalized_claims.json' for downstream steps.
...
def main():
    ...
    ap.add_argument("--infile", default="./resources/proof_claims_sample.json")
    ap.add_argument("--out", default="./resources/normalized_claims.json")
    args = ap.parse_args()
