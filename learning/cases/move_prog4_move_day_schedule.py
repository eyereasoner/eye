#!/usr/bin/env python3
"""
EYE Learning — Program 4: Move-Day Timeline & Checklist (ICS-lite)
...
Overview:
  ...
  - Emits a minimal ICS-like text plus a JSON artifact './resources/move_schedule.json'.
...
def main():
    ...
    ap.add_argument("--out", default="./resources/move_schedule.json")
    args = ap.parse_args()
    ...
    with open("./resources/move_schedule.ics.txt","w",encoding="utf-8") as f: f.write(sched["ics_text"])
    print("\nWrote ./resources/move_schedule.json and ./resources/move_schedule.ics.txt")
