#!/usr/bin/env python3
"""
EYE Learning — Program 3: Proof Sketch Builder (witnesses & steps)
...
Overview:
  - Reads './resources/normalized_claims.json' + './resources/lemma_library.json'.
  - For each claim, constructs a proof sketch with concrete witnesses.
  - Prints Answer/Reason/Check; writes './resources/proof_sketches.json' for Program 4.
"""
...
def main():
    ...
    ap.add_argument("--in_lib",  default="./resources/lemma_library.json")
    ap.add_argument("--out",     default="./resources/proof_sketches.json")
    args = ap.parse_args()
