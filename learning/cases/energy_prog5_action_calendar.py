#!/usr/bin/env python3
"""
EYE Learning — Program 5: Action Calendar (Reminders & ICS-lite)
...
Overview:
  - Reads './resources/baseline_daily.json' + './resources/savings_plan.json'.
  - Emits JSON reminders and an ICS-like text.
  - Prints Answer/Reasons/Check; writes './resources/actions.json' + './resources/actions.ics.txt'.
"""
...
def main():
    ...
    json.dump({"items":a["items"]}, open("./resources/actions.json","w",encoding="utf-8"), indent=2)
    open("./resources/actions.ics.txt","w",encoding="utf-8").write(a["ics_text"])
    print("\nWrote ./resources/actions.json and ./resources/actions.ics.txt")
