#!/usr/bin/env python3
"""
EYE Learning — Program 4: Mechanical Proof Checker (Model-check by computation)
...
Overview:
  - Reads './resources/proof_sketches.json'.
  - Checks witnesses and equalities by computation; recomputes gcd and mod conditions.
  - Prints Answer/Reason/Check; writes './resources/proof_verdicts.json' for Program 5.
"""
...
def main():
    ...
    ap.add_argument("--infile", default="./resources/proof_sketches.json")
    ap.add_argument("--out", default="./resources/proof_verdicts.json")
    args = ap.parse_args()
