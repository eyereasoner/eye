#!/usr/bin/env python3
"""
EYE Learning — Program 6: Final Report & CSV Export
...
Overview:
  - Reads './resources/baseline_daily.json' + './resources/tou_split.json' + './resources/bill_breakdown.json' + './resources/savings_plan.json'.
  - Emits './resources/energy_report.json' and './resources/energy_report.csv'.
...
def main():
    ...
    ap.add_argument("--in_plan", default="./resources/savings_plan.json")
    args = ap.parse_args()
    ...
    json.dump(report, open("./resources/energy_report.json","w",encoding="utf-8"), indent=2)
    write_csv(report, "./resources/energy_report.csv")
    print("\nWrote ./resources/energy_report.json and ./resources/energy_report.csv")
