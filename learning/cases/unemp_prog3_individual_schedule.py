...
#!/usr/bin/env python3
"""
EYE Learning — Program 3: Individual Payment Schedule & Compliance Checklist
...
Overview:
  Consume ./resources/eligible_claims.json and ./resources/budget_projection.json. For each eligible person,
  ...
  ./resources/individual_schedules.json.
"""
...
def main():
    ...
    ap.add_argument("--in_claims", default="./resources/eligible_claims.json")
    ap.add_argument("--in_budget", default="./resources/budget_projection.json")
    ...
    with open("./resources/individual_schedules.json","w",encoding="utf-8") as f:
        json.dump(sched, f, indent=2, ensure_ascii=False)
    print("\nWrote ./resources/individual_schedules.json")
