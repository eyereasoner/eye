#!/usr/bin/env python3
"""
EYE Learning — Program 3: Van Size & Trip Estimator
...
Overview:
  - Reads './resources/inventory_decisions.json' and uses kept volume/weight.
  ...
  - Prints Answer/Reason/Check and writes './resources/van_plan.json'.
"""
...
def main():
    ...
    ap.add_argument("--out", default="./resources/van_plan.json")
    args = ap.parse_args()
