#!/usr/bin/env python3
"""
EYE Learning — Program 1: Transaction Categorizer & Monthly Summary (Personal Finance)
...
Overview (what this file does, matching the chat explanation):
  ...
  - Prints Answer/Reason/Check and writes './resources/summary_month.json' for Program 2.
...
# Provide the file via --in ./resources/transactions.json
CATEGORY_RULES = {
...
def main():
    ...
    parser.add_argument("--in", dest="infile", default="./resources/transactions_sample.json", help="Path to transactions JSON")
    parser.add_argument("--out", default="./resources/summary_month.json")
