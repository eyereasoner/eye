...
Overview:
  - Reads './bus/baseline_daily.json' + './bus/savings_plan.json'.
  - Emits JSON reminders and an ICS-like text.
  - Prints Answer/Reasons/Check; writes './bus/actions.json' + './bus/actions.ics.txt'.
"""
...
def main():
    ...
    json.dump({"items":a["items"]}, open("./bus/actions.json","w",encoding="utf-8"), indent=2)
    open("./bus/actions.ics.txt","w",encoding="utf-8").write(a["ics_text"])
    print("\nWrote ./bus/actions.json and ./bus/actions.ics.txt")
