...
Overview:
  ...
  - Emits a minimal ICS-like text plus a JSON artifact './cases/bus/move/move_schedule.json'.
...
def main():
    ...
    ap.add_argument("--out", default="./cases/bus/move/move_schedule.json")
    args = ap.parse_args()
    ...
    with open("./cases/bus/move/move_schedule.ics.txt","w",encoding="utf-8") as f: f.write(sched["ics_text"])
    print("\nWrote ./cases/bus/move/move_schedule.json and ./cases/bus/move/move_schedule.ics.txt")
