...
Overview:
  - Reads './bus/normalized_claims.json'.
  - Emits a minimal library of facts keyed by claim type.
  - Prints Answer/Reason/Check; writes './bus/lemma_library.json' for Program 3.
...
def main():
    ...
    ap.add_argument("--infile", default="./bus/normalized_claims.json")
    ap.add_argument("--out", default="./bus/lemma_library.json")
    args = ap.parse_args()
