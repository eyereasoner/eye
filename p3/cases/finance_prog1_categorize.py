...
Overview (what this file does, matching the chat explanation):
  ...
  - Prints Answer/Reason/Check and writes './bus/summary_month.json' for Program 2.
...
# Provide the file via --in ./bus/transactions.json
CATEGORY_RULES = {
...
def main():
    ...
    parser.add_argument("--in", dest="infile", default="./bus/transactions_sample.json", help="Path to transactions JSON")
    parser.add_argument("--out", default="./bus/summary_month.json")
