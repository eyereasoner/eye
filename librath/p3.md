...
Inputs—**Data**, **Logic**, and **Question**—flow into an LLM-based synthesizer that emits a single, self-contained **Python program**. Executing that program produces three artifacts: the **Answer**, a **Reason Why** that explains it, and a **Check** that verifies it.
