...
head_body_('https://idlabresearch.github.io/ns#factorial'(0,s(0)),Rs,Rs).
head_body_('https://idlabresearch.github.io/ns#factorial'(s(N),F),['https://idlabresearch.github.io/ns#factorial'(N,F1),prod(s(N),F1,F)|Rs],Rs).
