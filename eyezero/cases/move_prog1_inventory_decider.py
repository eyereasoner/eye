...
Overview (what this file does, mirrored from this chat):
  - Reads items from a JSON file you provide (see ./cases/bus/move/inventory_sample.json).
...
def main():
    ...
    ap.add_argument("--in", dest="infile", default="./cases/bus/move/inventory_sample.json")
    ap.add_argument("--out", default="./cases/bus/move/inventory_decisions.json")
    args = ap.parse_args()
