...
Overview:
  Consume ./branches/bus/unemp/eligible_claims.json. Project weekly and total outlays; compare with
  a simple contribution model. Print Answer/Reason/Check; write ./branches/bus/unemp/budget_projection.json.
"""
...
def main():
    ...
    ap.add_argument("--in", dest="infile", default="./branches/bus/unemp/eligible_claims.json")
    ap.add_argument("--out", default="./branches/bus/unemp/budget_projection.json")
    args = ap.parse_args()
