...
Overview:
  Consume ./branches/bus/unemp/eligible_claims.json and ./branches/bus/unemp/budget_projection.json. For each eligible person,
  ...
  ./branches/bus/unemp/individual_schedules.json.
"""
...
def main():
    ...
    ap.add_argument("--in_claims", default="./branches/bus/unemp/eligible_claims.json")
    ap.add_argument("--in_budget", default="./branches/bus/unemp/budget_projection.json")
    ...
    with open("./branches/bus/unemp/individual_schedules.json","w",encoding="utf-8") as f:
        json.dump(sched, f, indent=2, ensure_ascii=False)
    print("\nWrote ./branches/bus/unemp/individual_schedules.json")
