...
Overview:
  - Reads './branches/bus/energy/tou_split.json'.
  - Applies multipliers: cost = kWh × tariff × (peak|off-peak multiplier).
  - Prints Answer/Reasons/Check; writes './branches/bus/energy/bill_breakdown.json' for Program 4.
"""
...
def main():
    ...
    ap.add_argument("--in", default="./branches/bus/energy/tou_split.json")
    ap.add_argument("--out", default="./branches/bus/energy/bill_breakdown.json")
    args = ap.parse_args()
