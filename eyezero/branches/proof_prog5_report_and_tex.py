...
Overview:
  - Reads './branches/bus/proof/normalized_claims.json' + './branches/bus/proof/proof_verdicts.json'.
  - Emits './branches/bus/proof/proof_report.json' and './branches/bus/proof/proof_report.tex.txt'.
...
def main():
    ...
    ap.add_argument("--in_norm", default="./branches/bus/proof/normalized_claims.json")
    ap.add_argument("--in_ver",  default="./branches/bus/proof/proof_verdicts.json")
    args = ap.parse_args()
    ...
    json.dump(rep, open("./branches/bus/proof/proof_report.json","w",encoding="utf-8"), indent=2)
    open("./branches/bus/proof/proof_report.tex.txt","w",encoding="utf-8").write(tex)
    print("\nWrote ./branches/bus/proof/proof_report.json and ./branches/bus/proof/proof_report.tex.txt")
