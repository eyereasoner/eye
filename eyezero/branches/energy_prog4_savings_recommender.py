...
Overview:
  - Reads './branches/bus/energy/baseline_daily.json' + './branches/bus/energy/tou_split.json' + './branches/bus/energy/bill_breakdown.json'.
  - Suggests: (a) shift all shiftable loads to off-peak; (b) 10% efficiency for fridge/TV.
  - Prints Answer/Reasons/Check; writes './branches/bus/energy/savings_plan.json' for Program 5.
"""
...
def main():
    ...
    ap.add_argument("--out", default="./branches/bus/energy/savings_plan.json")
    args = ap.parse_args()
