...
Overview:
  - Reads './branches/bus/move/inventory_decisions.json' and uses kept volume/weight.
  ...
  - Prints Answer/Reason/Check and writes './branches/bus/move/van_plan.json'.
"""
...
def main():
    ...
    ap.add_argument("--in", dest="infile", default="./branches/bus/move/inventory_decisions.json")
    ap.add_argument("--distance_km", type=float, default=12.0, help="one-way km between homes")
    ap.add_argument("--out", default="./branches/bus/move/van_plan.json")
    args = ap.parse_args()
