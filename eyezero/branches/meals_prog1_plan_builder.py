...
Overview:
  ...
  Prints Answer/Reason/Check and writes ./branches/bus/meal/meal_plan.json for Program 2.

Run:
  python meals_prog1_plan_builder.py --out ./branches/bus/meal/meal_plan.json --asof 2025-09-18
"""
...
def main():
    ...
    ap.add_argument("--out", default="./branches/bus/meal/meal_plan.json")
