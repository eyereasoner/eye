...
Usage:
  ...
  python phone.py --session delfour --bus ./branches/bus --retailer Delfour --device self-scanner --event pick_up_scanner --ttl-hours 2
"""
...
def parse_args():
    ...
    ap.add_argument("--bus", default="./branches/bus")
