...
Overview (matches the chat explanation):
  - Reads './branches/bus/finance/summary_month.json' from Program 1.
  ...
  - Prints Answer/Reason/Check and writes './branches/bus/finance/forecast_30d.json' for Program 3.
...
def main():
    ...
    parser.add_argument("--in", dest="infile", default="./branches/bus/finance/summary_month.json")
    parser.add_argument("--out", default="./branches/bus/finance/forecast_30d.json")
