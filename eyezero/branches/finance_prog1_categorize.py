...
Overview (what this file does, matching the chat explanation):
  ...
  - Prints Answer/Reason/Check and writes './branches/bus/finance/summary_month.json' for Program 2.
...
# Provide the file via --in ./branches/bus/finance/transactions.json
CATEGORY_RULES = {
...
def main():
    ...
    parser.add_argument("--in", dest="infile", default="./branches/bus/finance/transactions_sample.json", help="Path to transactions JSON")
    parser.add_argument("--out", default="./branches/bus/finance/summary_month.json")
