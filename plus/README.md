# Prolog with bottom-up steps - plus

- Besides top-down reasoning with `conclusion :- premise` rules, plus also does bottom-up reasoning with `conclusion :+ premise` rules.
