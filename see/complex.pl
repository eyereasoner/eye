...
'https://eyereasoner.github.io/see#atan'(A,B) :-
    ...
    add([[0,1],A],D),
    divide([C,D],E),
    'https://eyereasoner.github.io/see#log'([2.718281828459045,0],E,F),
    divide([F,[0,2]],B).
...
query('https://eyereasoner.github.io/see#exp'([2.718281828459045,0],[0,pi],_ANSWER)).
query('https://eyereasoner.github.io/see#log'([2.718281828459045,0],[-1,0],_ANSWER)).
