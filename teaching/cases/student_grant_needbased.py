#!/usr/bin/env python3
# =============================================================================
# Education — Need-based Student Grant (single-file EYE-teaching case with 4 specs)
# =============================================================================
...
#
# and implements the EYE-teaching style:
#   - Answer      : final result
...
- the Python in this file — a **single, self-contained script** that produces:
  **Answer**, **Reason why**, and a **Check (harness)** per EYE-teaching.
