...
if __name__ == "__main__":
    ...
    print("sudoku_201906 = %s" % (sudoku_201906))
    ...
    print("sudoku_201907 = %s" % (sudoku_201907))
    ...
    print("sudoku_201909 = %s" % (sudoku_201909))
    ...
    print("sudoku_201910 = %s" % (sudoku_201910))
    print("")
