...
main :-
    ...
    stages([G|GL]),
    plan_all(G,I,L,GL),
    L = [right(4),down(2),down(6),left(3),up(7),right(6),up(2),left(4),down(6),down(7),right(3),up(2),right(8),up(5),left(4),down(8),left(7),up(6),right(8),down(7),right(5),up(4),left(7),left(8)],
